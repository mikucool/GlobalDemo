...
object AdControllerFactory {
    fun createBiddingControllers(adConfigurations: List<AdConfiguration>): List<BiddingAdController> {
    ...
    fun createAdMobControllers(adConfiguration: AdConfiguration): AdMobController =
        AdMobController(adConfiguration)
}